...
\end{equation}
The uncorrected resolution floor is $1/(N_0+1)$. Passbands remain separate, with conservative within-object Bonferroni correction; the CLI records when the corrected resolution cannot reach the requested threshold.
...
\input{experiments/noise_results_table.tex}
