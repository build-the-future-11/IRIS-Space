...
R07 may be marked complete only after the repository's exact-head CI executes these tests successfully. A green test run is engineering qualification evidence only; it does not authorize scientific release or change P06 licensing status.
