...
BROKER_SNAPSHOT_SCHEMA = "iris.broker_snapshot.v1"
BROKER_SNAPSHOT_ID_SCHEMA = "iris.broker_snapshot.identity.v1"
BROKER_SNAPSHOT_ID_COLUMN = "_iris_broker_snapshot_id"
