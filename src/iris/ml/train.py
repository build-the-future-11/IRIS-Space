"""Small, reproducible training and checkpoint APIs for the IRIS TS-JEPA."""
...
from iris.atomic import atomic_create_binary
...
def batch_tensors(batch: Any, device: Any) -> tuple[Any, Any]:
    """Extract tokens and padding masks from IRIS or mapping-style batches."""
...
def train_jepa(
    ...
    *,
    ...
    loader_metadata: dict[str, Any] = {
        "source": "caller_dataloader" if external_loader else "iris_constructed_dataloader",
