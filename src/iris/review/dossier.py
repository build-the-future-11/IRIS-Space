...
from iris.provenance import stable_json
...
<title>IRIS review — {escape(candidate_id)}</title>
<style>
...
<body><h1>IRIS candidate {escape(candidate_id)}</h1>
