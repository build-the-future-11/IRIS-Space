...
from siderea.validation.gates import MANDATORY_SERVICES, GateDecision

CANDIDATE_EVIDENCE_SCHEMA = "siderea.candidate_evidence.v2"
CANDIDATE_OBSERVATIONS_SCHEMA = "siderea.candidate_observations.v1"
CANDIDATE_RECORD_SCHEMA = "siderea.candidate_record.v1"
CANDIDATE_RUN_BINDING_SCHEMA = "siderea.candidate_run_binding.v1"
...
def verify_candidate_version_payload(
    ...
    *,
    ...
    for name in ("require_authenticated", "trusted_assertion_key_ids"):
        if name in review:
            expected_review_policy[name] = review[name]
